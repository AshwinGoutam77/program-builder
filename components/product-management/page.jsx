...
const features = [
  ...
  },
  {
    ...
    description:
      "AI is not our competitor—it’s our greatest enabler. — Spotify Founder",
    icon: "/images/right-click.png",
  },
  {
    name: "Database backups.",
    description:
      "Every PM must be fluent in AI or risk becoming obsolete.— Duolingo Founder",
    icon: "/images/right-click.png",
  },
];
...
export default function ProductManagement() {
  ...
  return (
    <section
      ref={ref}
      className="project-management-section"
              ...
              <div className="card-inner">
                <div className="card-front">
                  ...
                  <p>
                    ...
                    everyday work routines is no longer a futuristic concept but
                    a current reality
                  </p>
                  <a
            ...
            <div className="card card-2">
              <div className="card-inner">
                <div className="card-front">
                  ...
                  <p>
                    Shopify CEO mandates AI proficiency for all employees
                    —signaling that mastering AI is now essential, not optional.
                  </p>
                  <a
