    ...
    return (
        <section className="bg-black footer-section">
            <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl pb-10">
                <h2>Rethink Systems</h2>
                <p className='text-white my-2'>Feel free to send your questions</p>
                <button className='primary-btn mt-3'>SEND A MESSAGE</button>
            </div>
            <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl border-t">
                <div className="grid grid-cols-2 gap-x-5 gap-y-12 md:grid-cols-3 md:gap-x-12">
                    <div>
                        <ul className="mt-8 space-y-4">
                            ...
                            <li>
                                <a href="#" title="" className="text-base text-white transition-all duration-200 hover:text-opacity-80 focus:text-opacity-80"> Testimonials </a>
                            </li>
                            <li>
                                <a href="#" title="" className="text-base text-white transition-all duration-200 hover:text-opacity-80 focus:text-opacity-80"> Past Program Experience </a>
                            </li>
                            <li>
                                <a href="#" title="" className="text-base text-white transition-all duration-200 hover:text-opacity-80 focus:text-opacity-80"> Live Program </a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div>
                        <ul className="mt-8 space-y-4">
                            <li>
                                <a href="#" title="" className="text-base text-white transition-all duration-200 hover:text-opacity-80 focus:text-opacity-80"> <h4 className='text-lg '>CONTACT</h4></a>
                            </li>
                            <li>
                                <a href="#" title="" className="text-base text-white transition-all duration-200 hover:text-opacity-80 focus:text-opacity-80"> info@rethinksystems.in </a>
                            </li>
                            <li>
                                <a href="#" title="" className="text-base text-white transition-all duration-200 hover:text-opacity-80 focus:text-opacity-80"> +91 8971790365 </a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div className="flex flex-wrap items-center justify-between">
                    ...
                    <p className="w-full mt-8 text-sm text-center text-gray-100 md:mt-0 md:w-auto md:order-2">© Copyright 2025, All Rights Reserved</p>
                </div>
            </div>
        </section>
    )
