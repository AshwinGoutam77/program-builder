...
const faqData = {
    GeneralInquiries: [
        ...
        },
        {
            ...
            answer: "We have a lot of our alumns mentioned on our website who you can DM on LinkedIn. A lot of them are also on our common WhatsApp groups so you can reach out to them there as well. If they feel you have the right mindset and hunger to learn and become 1% better everyday, they will be happy to refer you!"
        },
        {
            question: "Will we get a chance to meet our peers in person?",
            answer: "Yes! We host an offline Graduation Retreat at the end of every cohort — a 3-day weekend getaway filled with fun, learning, and real connection. It’s a separately paid experience where students and alumni come together to unwind, reflect, and celebrate after 9 intense weeks, alongside peers and seasoned industry leaders. We also host city-based meetups regularly, giving alumni more chances to connect, collaborate, and stay close to the community."
        },
        {
            question: "How do I know this program is for me?",
            answer: "If you are inherently curious and wanting to become 1% better everyday is the motto you live your life by, then this Program is definitely for you! It's a bonus if you are a PM/SPM or want to become one with at least 4 years of work experience."
        },
        {
            question: "How will classes take place in the cohort?",
            answer: "The teaching method is going to be online through a mix of live and recorded classes conducted over Zoom. The Program has been structured into 7 modules which will be covered across 9 weeks along with activities and a Productathon at the end of it."
        },
        {
        ...
        },
        {
            ...
            answer: "The upcoming program will be for 9 weeks starting 29th June 2025."
        },
        {
        ...
        {
            question: "Once I get shortlisted for this cohort, can I use the same application and join the next cohort?",
            answer: "While we would love to give the option to defer, it’ll be difficult for us to do so. Once you get shortlisted, you will only be shortlisted for that cohort. If you want to defer it, you will have to fill the application process again for the next Program as and when it comes!"
        },
        {
        ...
        {
            question: "I’ve already done/enrolled in a Program based course on product management, should I still join?",
            answer: "We encourage people to ask themselves a question which usually helps them answer this on their own. “Have I learnt all the skills necessary to become the best version of myself professionally and land my dream job?” If you think you haven’t, then you should consider applying as this is going to be a grilling 9 weeks. If you think you have, then it's all good, all the best for your future endeavors!"
        },
        {
            question: "Do you offer career support after course completion? (Interview prep, resume review)",
            answer: "Yes we do offer career support after the program. You can reach out to folks in the community or our mentors for career guidance, interview prep, portfolio building and resume review. They will gladly help you out. However it will depend on their availability once the Program ends. While you are in the Program, they will be available to take your queries."
        }
    ],
    ProgramLearning: [
        {
    ...
    ContentRealated: [
        ...
        },
        {
            ...
            answer: "Lab sessions are hands-on, build-first sessions where you apply what you’ve learned to solve real-world problems. You'll use AI tools, collaborate with your peers, and ship actual products. These sessions happen every Sunday where you will build with Shravan!"
        }
    ],
    PaymentRelated: [
        {
    ...
    Instructor: [
        ...
        },
        {
            ...
            answer: "After the Program ends, you will have the distinction of being an alumni of the Mastering Product Management Program 2.0 by Shravan Tickoo and Rethink Systems. You will be part of our alumni community where we keep doing some cool stuff, so you can have access to that. You can also take up roles of responsibility inside the community and get a chance to work with Rethink Systems!"
        },
        {
            question: "Do I get access to all of Rethink Systems events if I’m a Program alumni?",
            answer: "Yes you do! We do a lot of events in and out of the program. You will be eligible to attend all of them, even the invite only ones! Some events might be paid, but we will let you know that upfront through Slack and Whatsapp."
        }
    ]
